        ...
        <div class="leftTable">
          <a-table @change="tableChange" :columns="columns" :data-source="data" :pagination="false" :scroll="{ y: 350 }" style="height: 400px">
            ...
            <template slot="dosage" slot-scope="text">
              <a-input style="width: 60%" :value="text"></a-input>
              <span>{{ unit }}</span>
            </template>
            ...
            <template slot="total" slot-scope="text">
              <a-input style="width: 40%" :value="text"></a-input>
              <a-select style="width: 55%" @change="handleChange" default-value="ping">
                <a-select-option value="ping"> 瓶 </a-select-option>
              </a-select>
            </template>
