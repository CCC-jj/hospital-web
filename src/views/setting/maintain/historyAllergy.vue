<template>
  <div class="maintain">
    ...
    <div class="manageDown">
      ...
      <a-modal centered v-model="visible" title="编辑过敏史" @ok="handleOk">
        <a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
          <a-form-model-item label="过敏史内容" prop="content">
...
<script>
import { getAllergyList, editAllergyList, deleteAllergyList } from '@/api/setting'
...
export default {
  ...
  methods: {
    ...
    getMaintainList() {
      this.spinning = true
      getAllergyList(this.params).then((res) => {
    ...
    handleOk(e) {
      editAllergyList(this.form).then((res) => {
        if (res.success) {
