<template>
  <div class="maintain">
    ...
    <div class="manageDown">
      ...
      <a-modal centered v-model="visible" title="编辑辅助检查情况" @ok="handleOk">
        <a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
          <a-form-model-item label="辅助检查内容" prop="content">
...
<script>
import { getCheckList, editCheckList, deleteCheckList } from '@/api/setting'
...
export default {
  ...
  methods: {
    ...
    handleOk(e) {
      editCheckList(this.form).then((res) => {
        if (res.success) {
