    ...
    <div class="manageDown">
      ...
      <a-modal centered v-model="visible" title="编辑医嘱信息" @ok="handleOk">
        <a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
          <a-form-model-item label="医嘱信息" prop="content">
...
<script>
import { getAdviceList, editAdviceList, deleteAdviceList } from '@/api/setting'
...
export default {
  ...
  methods: {
    ...
    getMaintainList() {
      this.spinning = true
      getAdviceList(this.params).then((res) => {
    ...
    handleOk(e) {
      editAdviceList(this.form).then((res) => {
        if (res.success) {
