<template>
  <div class="maintain">
    ...
    <div class="manageDown">
      ...
      <a-modal centered v-model="visible" title="编辑治疗意见" @ok="handleOk">
        <a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
          <a-form-model-item label="治疗意见内容" prop="content">
...
<script>
import { getTreatmentList, editTreatmentList, deleteTreatmentList } from '@/api/setting'
...
export default {
  ...
  methods: {
    ...
    getMaintainList() {
      this.spinning = true
      getTreatmentList(this.params).then((res) => {
    ...
    onDelete(id) {
      deleteTreatmentList(id).then((res) => {
        if (res.success) {
    ...
    handleOk(e) {
      editTreatmentList(this.form).then((res) => {
        if (res.success) {
