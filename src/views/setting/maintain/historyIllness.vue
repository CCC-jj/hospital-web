<template>
  <div class="maintain">
    ...
    <div class="manageDown">
      ...
      <a-modal centered v-model="visible" title="编辑既往史" @ok="handleOk">
        <a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
          <a-form-model-item label="现病史内容" prop="content">
...
<script>
import { getH_illnessList, editH_illnessList, deleteH_illnessList } from '@/api/setting'
...
export default {
  ...
  methods: {
    ...
    getMaintainList() {
      this.spinning = true
      getH_illnessList(this.params).then((res) => {
    ...
    onDelete(id) {
      deleteH_illnessList(id).then((res) => {
        if (res.success) {
    ...
    handleOk(e) {
      editH_illnessList(this.form).then((res) => {
        if (res.success) {
